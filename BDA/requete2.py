...
if results:
    print("Les trois meilleurs films d'horreur des années 2000 sont :")
    for rank, row in enumerate(results, 1):
        print(f"{rank}. {row[0]} - Note moyenne des utilisateurs : {row[1]}")
else:
    print("Aucun film d'horreur des années 2000 trouvé dans la base de données.")
